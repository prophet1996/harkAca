 ...
 * @author Green
 */
public class CustomQuizRecyclerView extends RecyclerView {
    public CustomQuizRecyclerView(Context context) {
        super(context);
    }
...
//    }
//
//    public CustomQuizRecyclerView(Context context, AttributeSet attrs) {
//        this(context, attrs, 0);
//    }
//
//    public CustomQuizRecyclerView(Context context, AttributeSet attrs, int defStyle) {
